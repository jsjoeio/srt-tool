...
/* package srtTool-0.1.0.0 */
#ifndef VERSION_srtTool
#define VERSION_srtTool "0.1.0.0"
#endif /* VERSION_srtTool */
#ifndef MIN_VERSION_srtTool
#define MIN_VERSION_srtTool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_srtTool */
...
#define CURRENT_COMPONENT_ID "srtTool-0.1.0.0-inplace-srtTool"
